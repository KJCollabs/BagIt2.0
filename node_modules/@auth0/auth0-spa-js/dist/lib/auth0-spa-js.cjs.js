...
var switchFetch = function (url, audience, scope, opts, timeout, worker) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [4 /*yield*/, fetch__default['default'](url, opts)];
            case 2:
                response = _b.sent();
                _a = {
                    ok: response.ok
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 8]);
                        return [4 /*yield*/, oauthToken(__assign(__assign(__assign({}, this.customOptions), customOptions), { audience: audience,
                                scope: scope, baseUrl: this.domainUrl, client_id: this.options.client_id, grant_type: 'refresh_token', refresh_token: cache && cache.refresh_token, redirect_uri: redirect_uri }), this.worker)];
                    case 4:
                        tokenResult = _a.sent();
                        return [3 /*break*/, 8];
                    case 5:
